    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                ...
                <p class="text-slate-500 text-sm">Lacak posisi dokumen staf dan pantau riwayat pengajuan cuti pribadi Anda.</p>
            </div>

            <div class="mb-12">
                <div class="mb-4">
                    <h2 class="text-xl font-bold text-slate-900 flex items-center gap-2">
                        <i class="fas fa-users text-slate-400"></i> Berkas Pegawai Staf
                    </h2>
                    <p class="text-xs text-slate-500">Berkas dari staf bawahan yang telah Anda berikan persetujuan.</p>
                </div>

                {{-- Section Form Filter --}}
                <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 mb-6">
                    <form action="{{ route('kasi.riwayat.index') }}" method="GET" class="flex flex-col md:flex-row items-end gap-4">
                        ...
                        <div class="w-full md:w-1/4 flex gap-2">
                            ...
                            @if(request()->anyFilled(['status', 'bulan', 'tahun']))
                                <a href="{{ route('kasi.riwayat.index') }}" class="px-4 py-3 bg-slate-200 hover:bg-slate-300 text-slate-700 font-medium rounded-xl transition-all flex items-center justify-center" title="Reset Filter">
                            ...
                            <tbody class="divide-y divide-slate-100 text-slate-700">
                                @forelse($riwayatPegawaiLain as $item)
                                    <tr class="hover:bg-slate-50/50 transition-colors">
                                        ...
                                        <td class="px-6 py-4 text-center">
                                            <a href="{{ route('kasi.riwayat.show', $item->id) }}" class="inline-flex items-center gap-1.5 px-3 py-1.5 bg-slate-900 hover:bg-slate-800 text-white text-xs font-semibold rounded-lg transition-all shadow-sm">
                            ...
                            <tbody class="divide-y divide-slate-100 text-slate-700">
                                ...
                                <tr class="hover:bg-slate-50/50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 text-center flex items-center justify-center gap-2">
                                        ...
                                        @if($saya->status == 'Selesai' || $saya->status == 'Disetujui')
                                        <a href="{{ route('kasi.riwayat.cetak', $saya->id) }}" target="_blank" class="inline-flex items-center gap-1.5 px-3 py-1.5 bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-bold rounded-xl transition-all shadow-sm">
