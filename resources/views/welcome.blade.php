        ...
        <div class="max-w-7xl mx-auto px-6">
            <div class="flex justify-between h-20 items-center">
                ...
                <div class="hidden md:flex items-center space-x-4">
                    <a href="#beranda"
                        class="text-xs font-bold uppercase tracking-widest nav-link-btn active">Beranda</a>
                    ...
                    <a href="/login"
                        class="ml-6 btn-glow-yellow px-8 py-2.5 rounded-lg text-xs font-black tracking-widest uppercase">LOGIN</a>
                </div>
            </div>
        </div>
    </nav>
    ...
    <section id="beranda" class="relative h-screen flex items-center justify-center text-center overflow-hidden">
        ...
        <div class="container mx-auto px-6 relative z-10 flex flex-col items-center">
            <div class="max-w-4xl">
                ...
                <div class="flex flex-col sm:flex-row gap-5 justify-center" data-aos="fade-up-subtle"
                    data-aos-duration="1000" data-aos-delay="600">
                    <a href="#layanan"
                        class="btn-glow-yellow px-10 py-4 rounded-xl text-white font-bold text-sm tracking-widest uppercase">
                        Mulai Sekarang
                    </a>
                    <a href="#kontak"
                        class="btn-outline-hover bg-white/10 text-white px-10 py-4 rounded-xl font-bold text-sm tracking-widest uppercase border border-white/30">
                        Hubungi Kami
                    </a>
                </div>
            </div>
