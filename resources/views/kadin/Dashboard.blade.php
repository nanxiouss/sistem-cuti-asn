        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="relative rounded-3xl overflow-hidden bg-slate-900 shadow-2xl shadow-slate-200/50 mb-10 -mt-2">
                <div class="absolute inset-0">
                    <div class="absolute inset-0 bg-gradient-to-br from-lime-500/10 to-purple-500/20 mix-blend-overlay"></div>
                ...
                <div class="relative z-10 p-8 md:p-12 grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
                    <div class="lg:col-span-7 space-y-6">
                        <div class="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-lime-500/10 border border-lime-400/20 text-lime-300 text-xs font-semibold backdrop-blur-md cursor-default">
                            <span class="w-2 h-2 rounded-full bg-lime-400 shadow-[0_0_8px_rgba(99,102,241,0.8)] animate-pulse"></span>
                        ...
                        <div class="flex flex-wrap gap-4 pt-2">
                            <a href="{{ route('kadin.persetujuan.index') }}" class="px-6 py-3 bg-lime-500 hover:bg-lime-600 text-white rounded-xl font-bold shadow-lg shadow-lime-500/30 transition-all duration-300 ease-out transform hover:-translate-y-1">
                                Cek Antrean Berkas
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="lg:col-span-5 relative hidden md:block">
                        <div class="absolute -inset-1 bg-gradient-to-r from-lime-500 to-purple-500 rounded-3xl blur opacity-10"></div>
                ...
                <div class="bg-white p-6 rounded-3xl border border-slate-200 shadow-sm transition-all hover:shadow-md">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-[11px] text-lime-600 font-medium flex items-center gap-1 pt-2">
                                <i class="fas fa-calendar-check"></i> Total akumulasi instansi
                            </p>
                        </div>
                        <div class="w-14 h-14 bg-lime-50 text-lime-500 rounded-2xl flex items-center justify-center text-xl shadow-inner border border-lime-100/50">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2 bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden">
                    <div class="p-6 border-b border-slate-100 flex justify-between items-center bg-slate-50/50">
                        ...
                        <a href="{{ route('kadin.persetujuan.index') }}" class="text-lime-600 text-sm font-bold hover:text-lime-700 transition">Lihat Semua</a>
                    </div>
                                ...
                                <div class="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <div class="flex flex-wrap items-center gap-2 mt-1">
                                            <span class="inline-flex items-center gap-1 px-2 py-0.5 rounded-lg text-[10px] font-bold bg-lime-50 text-lime-700 border border-lime-100/30">
                                        ...
                                        <p class="text-[11px] text-slate-400 font-medium mt-1">
                                            ...
                                            <span class="text-lime-600 font-bold">({{ $item->lama_cuti }} Hari)</span>
                                        </p>
                                    </div>
                                </div>
