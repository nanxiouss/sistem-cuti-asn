                ...
                <div class="relative z-10 p-8 md:p-12 grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
                    <div class="lg:col-span-7 space-y-6">
                        ...
                        <div class="flex flex-wrap gap-4 pt-2">
                            <a href="{{ route('kadin.persetujuan.index') }}" class="px-6 py-3 bg-indigo-500 hover:bg-indigo-600 text-white rounded-xl font-bold shadow-lg shadow-indigo-500/30 transition-all duration-300 ease-out transform hover:-translate-y-1">
                                Cek Antrean Berkas
                            </a>
                        </div>
                    </div>
                        ...
                        <ul class="divide-y divide-slate-100">
                            ...
                            <li class="p-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4 hover:bg-slate-50 transition">
                                ...
                                <div class="flex items-center justify-between sm:justify-end gap-3 border-t sm:border-t-0 pt-3 sm:pt-0">
                                    ...
                                    <a href="{{ route('kadin.persetujuan.show', $item->id) }}" class="inline-flex items-center gap-1.5 px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white font-extrabold rounded-xl text-xs uppercase tracking-wider transition-all shadow-sm shadow-indigo-600/20">
