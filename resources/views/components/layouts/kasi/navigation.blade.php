    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-20">
            ...
            <div class="flex items-center gap-5">
                <a href="/" class="flex-shrink-0 flex items-center gap-4 group">
                    ...
                    <div class="leading-tight border-l-2 border-slate-200 pl-4">
                        ...
                        <p class="text-[9px] font-bold text-rose-500 uppercase tracking-[0.2em]">PANEL Kepala Seksi</p>
                    </div>
                </a>
            </div>
            ...
            <div class="hidden md:flex items-center gap-1 bg-white/50 backdrop-blur-sm p-1 rounded-full border border-white/40 shadow-sm self-center">
                ...
                <a href="{{ route('kasi.dashboard') }}" class="{{ $navClass }} {{ request()->routeIs('kasi.dashboard') ? $activeClass : $inactiveClass }}">
                    Dashboard
                </a>
            ...
            <div class="flex items-center gap-3 sm:gap-4">
                ...
                <div class="relative" @click.outside="profileOpen = false">
                    ...
                    <div x-show="profileOpen" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0 translate-y-2" x-transition:enter-end="opacity-100 translate-y-0" x-transition:leave="transition ease-in duration-150" x-transition:leave-start="opacity-100 translate-y-0" x-transition:leave-end="opacity-0 translate-y-2" class="absolute right-0 mt-3 w-56 bg-white rounded-2xl shadow-xl shadow-slate-200/50 border border-slate-100 py-2 z-50 origin-top-right" style="display: none;">
                        ...
                        <div class="py-1">
                            <a href="#" class="flex items-center px-5 py-2.5 text-sm text-slate-600 hover:bg-rose-50 hover:text-rose-600 transition-colors">
