...
<head>
    ...
    <title>{{ $title ?? 'Dashboard Kepala Bidang'}} - E-CUTI ESDM</title>
...
<body class="bg-slate-50 text-slate-800 antialiased flex flex-col min-h-screen">
    ...
    @include('components.layouts.kabid.navigation')
    ...
    <footer class="bg-whit border-t border-slate-200 mt-auto">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div class="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-slate-500">
                ...
                <span class="font-bold text-lime-600">Panel Kepala Bidang</span>
            </div>
        </div>
    </footer>
    @stack('scripts')
