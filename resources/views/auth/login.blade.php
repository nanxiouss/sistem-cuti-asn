...
<body class="bg-white h-screen overflow-hidden">
    ...
    <div class="flex h-full w-full">
        ...
        <div
            class="w-full lg:w-[45%] h-full flex flex-col justify-center px-8 sm:px-16 lg:px-24 bg-white relative z-10 overflow-y-auto">

            <div class="mb-12" data-aos="fade-down">
                <a href="{{ url('/') }}" class="flex items-center gap-3 group">
                    <img src="{{ asset('images/logo.PNG') }}" alt="Logo"
                        class="h-12 group-hover:scale-110 transition-transform duration-300">
                    <div class="leading-tight border-l-2 border-slate-200 pl-4">
                        <span
                            class="text-2xl font-black tracking-tighter text-slate-800 block group-hover:text-esdm-green transition-colors">E-CUTI</span>
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-6" data-aos="fade-up" data-aos-delay="200">
                @csrf <div class="space-y-2">
                    <label for="nip" class="text-xs font-bold text-slate-600 uppercase tracking-wider ml-1">NIP /
                        Username</label>
                    <div class="relative group">
                        ...
                        <i
                            class="fas fa-id-card absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 text-lg input-icon"></i>
                    </div>
                    @error('nip')
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative group">
                        ...
                        <i
                            class="fas fa-lock absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 text-lg input-icon"></i>
                ...
                <div class="flex items-center ml-1">
                    <input id="remember_me" type="checkbox" name="remember"
                        class="w-4 h-4 text-[#97C93E] border-gray-300 rounded focus:ring-[#97C93E]">
                ...
                <button type="submit"
                    class="w-full btn-glow-yellow py-4 rounded-xl font-bold text-sm tracking-[0.2em] uppercase mt-4">
            ...
            <div class="mt-12 text-center" data-aos="fade-up" data-aos-delay="300">
                <p class="text-xs text-slate-400 font-medium">
                    Belum punya akun? <a href="#"
                        class="text-slate-800 font-bold hover:text-[#97C93E] transition">Hubungi Admin</a>
                </p>
        ...
        <div class="hidden lg:block lg:w-[55%] relative h-full bg-slate-900 overflow-hidden">
            <img src="https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?q=80&w=2070&auto=format&fit=crop"
                class="absolute inset-0 w-full h-full object-cover opacity-80" alt="Office Building">
            ...
            <div class="absolute bottom-0 left-0 w-full p-16 z-10">
                <div class="bg-white/10 backdrop-blur-md border border-white/10 p-8 rounded-3xl max-w-lg"
                    data-aos="fade-right" data-aos-delay="400">
                    <div class="text-[#F1B320] text-3xl mb-4">
                        <i class="fas fa-quote-left"></i>
                    </div>
                    <p class="text-white text-xl font-light leading-relaxed mb-6">
                        "Transformasi digital bukan sekadar tentang teknologi, tetapi tentang kemudahan, kecepatan, dan
