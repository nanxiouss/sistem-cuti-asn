<x-layouts.sekdin.app>
    <x-slot:title>Detail & Tracking Riwayat Cuti - Sekretaris Dinas</x-slot:title>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex items-center gap-3 mb-8">
                <div>
                    ...
                    <p class="text-xs text-slate-500 mt-0.5">Melihat arsip detail data pengajuan beserta rekam jejak persetujuan berkas.</p>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="space-y-6">
                    <div class="bg-slate-900 rounded-2xl p-6 shadow-md text-white border border-slate-800">
                        ...
                        {{-- Riwayat Tindakan Akun Sekdin --}}
                        <div class="border-t border-slate-800 pt-4 space-y-4">
                            <div>
                                <label class="block text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1.5">Tindakan Anda (Sekretaris Dinas)</label>
                                ...
                                <span class="text-[11px] text-slate-500 block mt-1 font-mono">
                                    Pada: {{ $pengajuan->tgl_ttd_sekdin ? \Carbon\Carbon::parse($pengajuan->tgl_ttd_sekdin)->translatedFormat('d M Y, H:i') . ' WIB' : '-' }}
                                </span>
                            </div>

                            {{-- Tampilan Catatan Internal Sekdin --}}
                            ...
                            <div class="bg-slate-800/50 rounded-xl p-3 border border-slate-800 text-xs">
                                ...
                                <p class="text-slate-300 italic">"{{ $pengajuan->catatan_sekdin }}"</p>
                            </div>
                            @endif

                            {{-- QR Code TTD Sekdin --}}
                            <div class="border-t border-slate-800/80 pt-4 flex flex-col items-center justify-center">
                                <span class="text-[10px] font-extrabold uppercase tracking-widest text-slate-500 block mb-2 text-center">Spesimen TTD Anda<br>(QR Sekretaris Dinas)</span>
                                <div class="flex items-center gap-3 relative p-2 bg-white rounded-xl shadow-inner min-h-[65px] w-full justify-center">
                                    ...
                                    <img src="{{ asset('storage/' . $pengajuan->ttd_sekdin) }}" alt="Tanda Tangan QR Sekdin" class="h-[140px] w-[140px] object-contain">
                                    @else
