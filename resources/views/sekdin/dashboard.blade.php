    ...
    <x-slot name="header">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
                ...
                <p class="text-xs text-slate-500 mt-0.5">Monitoring & persetujuan akhir berkas cuti tingkat Sekretariat / Dinas.</p>
            </div>
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-[11px] text-amber-600 font-medium flex items-center gap-1 pt-2">
                                <i class="fas fa-clock"></i> Perlu persetujuan Anda
                            </p>
                        </div>
