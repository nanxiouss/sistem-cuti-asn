            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="space-y-6">
                    <div class="bg-slate-900 rounded-2xl p-6 shadow-md text-white">
                        <h3 class="text-lg font-bold mb-4 border-b border-slate-700 pb-3">Tindakan Sekdin</h3>
                        <form action="{{ route('sekdin.persetujuan.update', $pengajuan->id) }}" method="POST">
                            ...
                            <div class="flex flex-col gap-3">
                                <button type="submit" name="status" value="Disetujui" class="w-full py-3 bg-teal-500 hover:bg-teal-600 text-white font-bold rounded-xl">
                                    SETUJUI PENGAJUAN
                                </button>
