                ...
                <div class="space-y-6">
                    <div class="bg-slate-900 rounded-2xl p-6 shadow-md text-white border border-slate-800">
                        ...
                        <p class="text-xs text-slate-400 mb-5 leading-relaxed">
                            Berkas yang disetujui akan dibubuhkan spesimen TTD Anda dan diteruskan secara otomatis ke meja Kepala Dinas (Kadin) untuk persetujuan akhir.
                        </p>
                        ...
                        <form action="{{ route('sekdin.persetujuan.update', $pengajuan->id) }}" method="POST">
                            ...
                            <div class="mb-4">
                                <label class="block text-xs font-semibold text-slate-300 uppercase tracking-wider mb-2">
                                    Catatan Sekretaris Dinas <span class="text-[10px] text-rose-400 font-normal lowercase">(wajib jika menolak)</span>
                                </label>
                                <textarea name="catatan_sekdin" rows="3" class="w-full bg-slate-800 border-slate-700 text-white rounded-xl focus:ring-lime-500 focus:border-lime-500 text-xs placeholder-slate-500" placeholder="Tambahkan instruksi / alasan jika menolak..."></textarea>
                            </div>
