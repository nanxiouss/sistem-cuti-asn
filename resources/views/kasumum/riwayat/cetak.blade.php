<x-layouts.kasumum.app>
    <div class="mb-6 flex items-center justify-between no-print">
        <div>
            ...
            <p class="text-slate-500 text-sm">Pratinjau formulir BKN Anda. Pastikan kertas pada printer diatur ke ukuran
                F4/Folio.</p>
        </div>
        <div class="flex gap-2">
            ...
            <button onclick="window.print()"
                class="px-5 py-2 bg-slate-900 text-white text-sm font-bold rounded-lg hover:bg-slate-800 transition flex items-center gap-1.5 shadow-md">
    ...
    {{-- ========================================================================= --}}
    {{-- KANVAS PREVIEW FORMULIR BKN (KHUSUS KASUBBAG UMUM) --}}
    {{-- ========================================================================= --}}
    <div
        ...
        <table class="w-full border-collapse border border-black mb-1 table-fixed text-[10px]">
            ...
            <tr class="h-[70px]">
                ...
                <td class="border border-black px-1.5 py-0.5 align-top text-justify relative">
                    ...
                    {{-- Nama Sekdin diambil dari relasi atasan --}}
                    <p class="font-bold underline uppercase mx-1 text-[10px]">{{ $pengajuan->nama_sekdin ??
                        ($kabid->nama ?? '.......................') }}</p>
                    <p class="text-[9px] mx-1">NIP. {{ $pengajuan->nip_sekdin ?? ($kabid->nip ??
                        '.......................') }}</p>
                </td>
            </tr>
        </table>
