                ...
                <div class="relative z-10 p-8 md:p-12 grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
                    <div class="lg:col-span-7 space-y-6">
                        ...
                        <h1 class="text-4xl md:text-5xl font-extrabold tracking-tight leading-tight">
                            <span class="text-transparent bg-clip-text bg-gradient-to-r from-lime-400 to-emerald-300">{{ $sapaan ?? 'Selamat Datang' }},</span> <br>
                            <span class="text-transparent bg-clip-text bg-gradient-to-r from-slate-100 to-slate-300">
                                {{ $user->nama ?? $user->name ?? 'Kasubbag Umum' }}
                            </span>
                        </h1>
                        ...
                        <div class="flex flex-wrap gap-4 pt-2">
                            <a href="{{ route('kasumum.persetujuan.index') }}"
                                class="px-6 py-3 bg-lime-400 hover:bg-lime-500 text-slate-900 rounded-xl font-bold shadow-lg shadow-lime-400/20 transition-all duration-300 ease-out transform hover:-translate-y-1">
                                Cek Antrean Berkas
                            </a>
                        </div>
                    </div>
                                ...
                                @foreach($pengajuanButuhAksi as $item)
                                    <li class="p-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4 hover:bg-slate-50 transition">
                                        ...
                                        <div class="flex items-center justify-between sm:justify-end gap-3 border-t sm:border-t-0 pt-3 sm:pt-0">
                                            ...
                                            <a href="{{ route('kasumum.persetujuan.show', $item->id) }}" 
                                               class="inline-flex items-center gap-1.5 px-3 py-2 bg-lime-400 hover:bg-lime-500 text-slate-900 font-extrabold rounded-xl text-xs uppercase tracking-wider transition-all shadow-sm">
