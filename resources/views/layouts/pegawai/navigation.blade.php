        ...
        <div class="flex justify-between h-20">
            ...
            <div
                ...
                <a href="{{ route('pegawai.pengajuan.create') }}"
                    class="{{ $navClass }} {{ request()->routeIs('pegawai.pengajuan*') ? $activeClass : $inactiveClass }}">
                    Ajukan Cuti</a>
            ...
            <div class="flex items-center gap-3 sm:gap-4">
                ...
                <button
                    class="relative p-2.5 text-slate-400 hover:text-lime-600 hover:bg-lime-50 rounded-full transition-all duration-200 focus:outline-none">
                ...
                <div class="relative" @click.outside="profileOpen = false">
                    <button @click="profileOpen = !profileOpen"
                        ...
                        <div class="hidden sm:flex flex-col items-start justify-center text-left pr-1">
                            <span
                                class="text-sm font-bold text-slate-700 group-hover:text-lime-700 transition leading-tight">
                                {{ Auth::user()->nama }}
                            </span>
                            <span
                                class="text-[10px] font-bold px-1.5 py-0.5 rounded bg-lime-50 text-lime-600 tracking-wider uppercase border border-lime-100 mt-1">
                    ...
                    <div x-show="profileOpen" x-transition:enter="transition ease-out duration-200"
                        ...
                        <div class="py-1">
                            <a href="#"
                                class="flex items-center px-5 py-2.5 text-sm text-slate-600 hover:bg-lime-50 hover:text-lime-600 transition-colors">
