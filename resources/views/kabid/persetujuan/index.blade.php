    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
                <div>
                    <h1 class="text-3xl font-extrabold text-slate-950 tracking-tight">Persetujuan Cuti Pegawai</h1>
            ...
            <div class="bg-white rounded-3xl shadow-sm border border-slate-200 overflow-hidden">
                <div class="p-6 border-b border-slate-100 bg-slate-50/50 flex items-center justify-between">
                    <h3 class="font-bold text-slate-800 text-base flex items-center gap-2.5">
                        ...
                        Antrean Masuk <span class="px-2 py-0.5 bg-slate-200 text-slate-700 text-xs rounded-md font-extrabold">{{ $pengajuan->count() }}</span>
                    </h3>
                </div>
                            ...
                            <tr>
                                <td colspan="5" class="px-6 py-16 text-center text-slate-400">
                                    <div class="flex flex-col items-center justify-center gap-3">
                                        ...
                                        <p class="font-medium text-slate-700">Semua berkas telah diproses</p>
                                        <p class="text-xs text-slate-400">Tidak ada pengajuan baru yang tertahan di meja Kabid hari ini.</p>
                                    </div>
                                </td>
                            </tr>
                            @endforelse
